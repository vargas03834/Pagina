...
export const initialState = {"state": {"is_hydrated": false, "router": {"session": {"client_token": "", "client_ip": "", "session_id": ""}, "headers": {"host": "", "origin": "", "upgrade": "", "connection": "", "pragma": "", "cache_control": "", "user_agent": "", "sec_websocket_version": "", "sec_websocket_key": "", "sec_websocket_extensions": "", "accept_encoding": "", "accept_language": ""}, "page": {"host": "", "path": "", "raw_path": "", "full_path": "", "full_raw_path": "", "params": {}}}}, "state.states": {}, "state.on_load_internal_state": {}, "state.state": {}, "state.update_vars_internal_state": {}}
...
export const StateContexts = {
  ...
  state__states: createContext(null),
...
export function StateProvider({ children }) {
  ...
  const [state__states, dispatch_state__states] = useReducer(applyDelta, initialState["state.states"])
  ...
  const dispatchers = useMemo(() => {
    return {
      ...
      "state.states": dispatch_state__states,
  ...
  return (
    ...
    <StateContexts.state__states.Provider value={ state__states }>
    ...
    </StateContexts.state__states.Provider>
